...
{ 	
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_8|GPIO_PIN_9;           //选择IO口
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);                //初始化
	
	HAL_GPIO_WritePin(GPIOB,GPIO_PIN_8,GPIO_PIN_SET);//输出高电平
	HAL_GPIO_WritePin(GPIOB,GPIO_PIN_9,GPIO_PIN_SET);//输出高电平
